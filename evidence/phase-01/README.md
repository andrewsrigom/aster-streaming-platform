...
- Closeout: PR 18 squash `b0544c9`; protected `33047330768` and exact post-merge `33047629326` passed.
...
| Docker-only Identity image and final evaluator profiles | P01-R10 | RELEASED through PR 18; exact post-merge passed | [`docker-demo.txt`](docker-demo.txt) |
