...
| Keyboard and semantics | Public navigation, profile creation/selection, modal focus trap, Escape, focus restoration and reduced-motion behavior pass browser checks; actual screen-reader review remains open |
