...
Status: Phases 03–09 are released. Catalog provides the rights-aware editorial application, operator CLI, published-only Federation v2 owner, private Playback/Engagement/Discovery reads and [one locally published film](../../evidence/phase-06/publication.md). The first Phase10 cache slice is a local candidate, not released behavior.
