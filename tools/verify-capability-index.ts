...
export const CAPABILITY_INDEX_ROWS = [
  {
    ...
    targets: {
      ...
      "Adverse test": [
        "../../services/identity/test/profiles.test.ts",
        "../../services/identity/test/integration/profiles-worker.ts",
        "../../services/identity/test/integration/subgraph-worker.ts",
      ],
  ...
  },
  {
    ...
    targets: {
      ...
      "Adverse test": [
        "../../services/catalog/test/integration/processing-postgres.ts",
        "../../tools/media/scratch-cleanup.test.mjs",
        "../../services/catalog/test/publication-rollback.test.ts",
      ],
  ...
  },
  {
    ...
    targets: {
      ...
      Evidence: [
        "../../evidence/phase-12/trace-contract.txt",
        "../../evidence/phase-12/trace-continuity.txt",
        "../../evidence/phase-12/cardinality-review.txt",
        "../../evidence/phase-12/exporter-failure.txt",
      ],
