...
| Grafana Tempo | `grafana/tempo:3.0.0` | AGPL-3.0-only; the official image is used unmodified as a separate diagnostics-only local service and Aster adds only MIT configuration | [Tempo source and license](https://github.com/grafana/tempo/tree/v3.0.0), [release](https://github.com/grafana/tempo/releases/tag/v3.0.0), and [local installation](https://grafana.com/docs/tempo/latest/set-up-for-tracing/setup-tempo/deploy/locally/linux/) |
