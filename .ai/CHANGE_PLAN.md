...
12. [in progress] Correct the post-merge cold typecheck ordering exposed by run `33026244011`, add the exact task-policy regression, remove generated state, repeat the forced graph, publish one corrective pull request, require protected CI, merge, verify `main`, and rebase the saved P01-R08 branch.
