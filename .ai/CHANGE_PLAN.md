...
9. [in progress] Commit the green broker checkpoint, then run one stabilized complete gate, exact clean-checkout proof, initial review, batched blocking remediation, confirmation review, protected CI, merge, and post-merge verification.
