...
| 10 | Create the authorized public GitHub repository and apply verified protections | P00-R07 | BLOCKED_BY_9 |
| 11 | Integrate `.ai/` state checks into the normal contribution workflow | P00-R08 | BLOCKED_BY_9 |
| 12 | Document exact bootstrap, check, demo, and cleanup commands | P00-R09 | READY |
| 13 | Verify a clean checkout, capture the Phase 00 evidence index, and close the phase | P00-R10 | BLOCKED_BY_9_10_11_12 |
