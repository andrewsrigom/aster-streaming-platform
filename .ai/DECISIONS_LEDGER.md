...
|---|---:|---|---|---|
| Local observability-container versions and final profile sizing | 01 | Architecture support, local resource use, health behavior, license, and OTLP/Prometheus integration | Core, Kafka and S3 are proved only in isolated local fixtures; no backend or final evaluator profile is claimed | Phase 01 verification |
