...
| Kafka client library | 01 | Node.js 24 compatibility, deadline and cancellation behavior, close semantics, maintenance, license, security, runtime cost, exit strategy, and focused real-dependency spike | Use only repository-owned ports and the current local adapter checkpoints | P01-R07 broker checkpoint |
