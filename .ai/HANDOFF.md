...
1. P01-R10 is active on `feat/p01-r10-docker-demo`, following released PR 17/main `a1f7281`; P01-R09 protected/post-merge runs `33041524806`/`33041787663` pass. Packaging/runtime commits: `4837207`, `166cc3c`. Source `38801ce` plus clean-acceptance prose is ready to publish; no P01-R10 PR yet.
...
6. Next publish the coherent P01-R10 candidate, await protected CI (including real matrix and Docker-built full profile), confirm review, record hosted evidence, squash and check post-merge. Then activate P02-R01 for the identity/session/local-trust ADR, not direct account implementation.
