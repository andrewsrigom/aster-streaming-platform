...
P00-R01, the Phase 00 alignment audit, P00-R11, P00-R03, P00-R02, and P00-R04 are complete. No application implementation has started.
...
5. Select only the first `READY` item: P00-R05, executable documentation validation.
6. Move P00-R05 to `IN_PROGRESS` and create `.ai/CHANGE_PLAN.md` from `docs/templates/WORK_ITEM_TEMPLATE.md`.
7. Implement the smallest bounded repository-owned validator for Markdown links, titles, fences, terminology, and unsupported status claims, with adverse fixtures and task-graph integration.
