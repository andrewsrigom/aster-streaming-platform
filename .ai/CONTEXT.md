...
P01-R05 lifecycle, P01-R06 telemetry, and P01-R07 platform adapters are released. P01-R08 composition is active from corrective released `main`; deadline, recoverable readiness, the single monitor, fixed health routes, minimum configuration, and controlled Identity orchestration are implemented. Real factory composition and the process diagnostic are next. P01-R09 real integration and P01-R10 resource-aware closeout remain later work. `docs/architecture/RUNTIME_PLATFORM_RUNWAY.md` distinguishes released capabilities from active and later work.
