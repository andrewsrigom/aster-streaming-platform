...
P01-R05 lifecycle, P01-R06 telemetry, and P01-R07 platform adapters are released. P01-R08 deadline/readiness composition is active from corrective released `main`; its propagated deadline checkpoint is implemented, and readiness is next. P01-R09 real integration and P01-R10 resource-aware closeout remain later work. `docs/architecture/RUNTIME_PLATFORM_RUNWAY.md` distinguishes released capabilities from the active composition work and later unimplemented capabilities.
